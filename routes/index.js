module.exports = (app) => {
  ...
  var students = [
    ...
    { index: 18, count: 0, name: "谢尔夫", id: "201813138063" },
    { index: 19, count: 0, name: "曾明昱", id: "201813138066" },
    { index: 20, count: 0, name: "唐孜辰", id: "201813138069" },
    { index: 21, count: 0, name: "朱万坤", id: "201813138070" },
    { index: 22, count: 0, name: "刘国昊", id: "201813138075" },
    { index: 23, count: 0, name: "陈嘉明", id: "201813138080" },
    { index: 24, count: 0, name: "王凯文", id: "201813138081" },
    { index: 25, count: 0, name: "乐青青", id: "201813138086" },
    { index: 26, count: 0, name: "张欣", id: "201813138087" },
    { index: 27, count: 0, name: "易梦华", id: "201813138096" },
    { index: 28, count: 0, name: "黄小喻", id: "201813138103" },
    { index: 29, count: 0, name: "储晓杰", id: "201813138109" },
    { index: 30, count: 0, name: "吴家豪", id: "201813138117" },
  ];
